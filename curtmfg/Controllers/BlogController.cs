    ...
    public class BlogController : BaseController {
        ...
        public void Feed(string type = "") {
            ...
            if (type.ToLower() == "rss") {
                ...
                rss_channel.Add(new XElement("title", "CURT Manufacturing Blog"));
                rss_channel.Add(new XElement("link", "http://www.curtmfg.com/blog"));
                rss_channel.Add(new XElement("description", "Your one-stop trailer hitch and towing guide"));
                rss_channel.Add(new XElement("copyright", "© " + String.Format("{0:yyyy}", DateTime.Now) + " CURT Manufacturing"));
                ...
                foreach (PostWithCategories post in posts) {
                    ...
                    item.Add(new XElement("author", post.author.fname + " " + post.author.lname));
                ...
                feed_container.Add(new XElement("{http://www.w3.org/2005/Atom}title", "CURT Manufacturing Blog"));
                feed_container.Add(new XElement("{http://www.w3.org/2005/Atom}subtitle", "Your one-stop trailer hitch and towing guide"));
                XElement selflink = new XElement("{http://www.w3.org/2005/Atom}link");
                selflink.Add(new XAttribute("href", "http://www.curtmfg.com/blog/feed/atom"));
                ...
                bloglink.Add(new XAttribute("href", "http://www.curtmfg.com/blog/"));
                feed_container.Add(bloglink);
                feed_container.Add(new XElement("{http://www.w3.org/2005/Atom}id", "http://www.curtmfg.com/"));
                ...
                feed_container.Add(new XElement("{http://www.w3.org/2005/Atom}rights", "© " + String.Format("{0:yyyy}", DateTime.Now) + " CURT Manufacturing"));
                foreach (PostWithCategories post in posts) {
                    ...
                    item.Add(new XElement("{http://www.w3.org/2005/Atom}author",
                            new XElement("{http://www.w3.org/2005/Atom}name", post.author.fname + " " + post.author.lname),
        ...
        public void CategoryFeed(string name = "", string type = "") {
            ...
            if(category != null) {
                if (type.ToLower() == "rss") {
                    ...
                    rss_container.Add(rss_version);
                    XElement rss_channel = new XElement("channel");
                    rss_channel.Add(new XElement("title", "CURT Manufacturing Blog - Posts in Category '" + category.name + "'"));
                    rss_channel.Add(new XElement("link", "http://www.curtmfg.com/blog/category/" + name));
                    rss_channel.Add(new XElement("description", "Your one-stop trailer hitch and towing guide"));
                    rss_channel.Add(new XElement("copyright", "© " + String.Format("{0:yyyy}", DateTime.Now) + " CURT Manufacturing"));
                    rss_channel.Add(new XElement("language", "en-us"));
                    rss_channel.Add(new XElement("lastBuildDate", String.Format("{0:ddd, dd MMM yyyy HH':'mm':'ss 'CST'}", lastBuild)));
                    ...
                    XDocument xml = new XDocument();
                    XElement feed_container = new XElement("{http://www.w3.org/2005/Atom}feed");
                    feed_container.Add(new XElement("{http://www.w3.org/2005/Atom}title", "CURT Manufacturing Blog - Posts in Category '" + category.name + "'"));
                    feed_container.Add(new XElement("{http://www.w3.org/2005/Atom}subtitle", "Your one-stop trailer hitch and towing guide"));
                    XElement selflink = new XElement("{http://www.w3.org/2005/Atom}link");
                    selflink.Add(new XAttribute("href", "http://www.curtmfg.com/blog/category/" + name + "/feed/atom"));
                    selflink.Add(new XAttribute("rel", "self"));
                    feed_container.Add(selflink);
                    XElement bloglink = new XElement("{http://www.w3.org/2005/Atom}link");
                    bloglink.Add(new XAttribute("href", "http://www.curtmfg.com/blog/category/" + name));
                    feed_container.Add(bloglink);
                    feed_container.Add(new XElement("{http://www.w3.org/2005/Atom}id", "http://www.curtmfg.com/"));
                    feed_container.Add(new XElement("{http://www.w3.org/2005/Atom}updated", String.Format("{0:yyyy-MM-dd'T'HH:mm:ss'Z'}", lastBuild.ToUniversalTime())));
                    feed_container.Add(new XElement("{http://www.w3.org/2005/Atom}rights", "© " + String.Format("{0:yyyy}", DateTime.Now) + " CURT Manufacturing"));
